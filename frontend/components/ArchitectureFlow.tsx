...
const nodes = [
  { label: "Code Analyzer", icon: "🔍", color: "accent-purple" },
  { label: "Infrastructure", icon: "☁️", color: "accent-purple-light" },
  { label: "Database", icon: "🗄️", color: "accent-green" },
  { label: "Backend", icon: "⚙️", color: "accent-purple" },
  { label: "Frontend", icon: "🎨", color: "accent-green" },
];
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-4 relative z-10">
            {nodes.map((node, i) => (
              ...
              >
                {/* Node circle */}
                <motion.div
                  className={`w-16 h-16 rounded-full bg-bg-card border-2 border-${node.color}/30 flex items-center justify-center text-2xl mb-3 relative`}
                  animate={
                    isInView
                      ? {
                          boxShadow: [
                            `0 0 0px rgba(98, 20, 217, 0)`,
                            `0 0 20px rgba(98, 20, 217, 0.3)`,
                            `0 0 0px rgba(98, 20, 217, 0)`,
                          ],
                        }
                      : {}
